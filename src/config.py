...
PREFIX_KEYS_QUERIES = os.getenv("PREFIX_KEYS_QUERIES", "monkey:queries")
PREFIX_KEYS_TRANSLATIONS = os.getenv("PREFIX_KEYS_TRANSLATIONS", "monkey:translations")
...
GOOGLE_IMAGES_SEARCH_API_KEY = os.getenv("GOOGLE_IMAGES_SEARCH_API_KEY")
GOOGLE_IMAGES_SEARCH_CX = os.getenv("GOOGLE_IMAGES_SEARCH_CX")
